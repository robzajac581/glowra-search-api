-- APPLY: copy PriceUnit from best matching approved DraftProcedures onto live Procedures.
-- Run backfillProceduresPriceUnitFromDrafts.preview.sql first and spot-check samples.
-- Only updates rows where Procedures.PriceUnit is NULL or blank.
